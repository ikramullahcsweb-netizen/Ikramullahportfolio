...
const ProjectCard = ( {title , main,button1,button2,button3,date,more,li,paragraph,li1,li2,li3,li4,li5,button4,button5})  => {
  ...
  return (
    <div>
    <div className='  md:w-95  md:m-1 h-55  p-2 flex flex-col  mr-1    rounded-xl hover:opacity-60  duration-800 hover:scale-103  bg-white border-gray-300 border-1 font-sans ' onClick={()=>setShowModel(true)} >
    ...
    {showModel && (
         ...
         <div className='fixed bg-black/30 h-screen z-10 w-screen flex justify-center items-center top-0 right-0  '>
          <div className='bg-white p-4 md:w-160 sm:h-85 h-120  md:top-[20%] lg:right-[50%] md:right-340 md:bottom-[130%] lg:left-[30%] md:left-22 left-3 right-3 top-60 bottom-3 hover:none justify-center fixed rounded-2xl'>
            ...
            <div className='absolute top-2 right-2 cursor-pointer'>
              < FiX  size={15} onClick={()=>setShowModel(false)}/>
            </div>
          </div>
