  ...
  return (
    ...
    {showModel && (
         ...
         <div className='fixed bg-black/30 h-screen z-10 w-screen flex justify-center items-center top-0 right-0  '>
          <div className='bg-white p-4 md:w-160 sm:h-85 h-100  md:top-[20%] lg:right-[50%] md:right-340 md:bottom-[130%] lg:left-[30%] md:left-22 left-3 right-3 top-60 bottom-3 hover:none justify-center fixed rounded-2xl'>
